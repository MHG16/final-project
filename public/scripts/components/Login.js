			...
			<section className="page-login container">
				<div className="offset-by-four four columns">
					<form onSubmit={this.login} className="login-box"> <h1>Login</h1>
						...
						<div className="error u-full-width">{this.state.errors.email ? this.state.errors.email.message : null} </div> 
						...
						<div className="error u-full-width">{this.state.errors.password ? this.state.errors.password.message : null}</div>
